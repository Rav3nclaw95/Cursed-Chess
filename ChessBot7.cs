...
//Need to make NextLegalMove use equal to for getting a better eval
//Make getting material be each piece has a list of 64 floats for each square on the board
public class ChessBot7 : MonoBehaviour
{
    ...
    */
    ...
    public float EvaluateBoard(int[,,] AnalyzedIntBoard, int[,] AnalyzedSideBoard, int pastX, int pastY, int CurX, int CurY){
        ...
        Debug.Log("Test spot: "+ AnalyzedIntBoard[0, 3, 0]);
        for (int y = 0; y <= 7; y++){
            for (int x = 0; x <= 7; x++){
    ...
    public int[,,] MoveIntPiece(int[,,] ChangedIntBoard, int[,] ChangedSideBoard, int x, int y, int dx, int dy){
        Debug.Log("MoveIntPiece given cords("+ dx +", "+ dy +") to ("+ x +", "+ y +")");
        ...
        float Evaluation = 0f;
            ...
            if (AnalyzedIntBoard[y, x, m] == 2){
                if (y + 1 <= 7 && x + 2 <= 7 && AnalyzedSideBoard[y + 1, x + 2] != AnalyzedSideBoard[y, x]){
                    ...
                    MoveIntPiece(CheckingIntBoard, AnalyzedSideBoard, x, y, x + 2, y + 1);
                    ...
                    for (int m = 0; m <= 7; m++){
                        if (UsedSideBoard[y, x] == GivenSide && UsedIntBoard[y, x, m] != 0){
                            if (UsedSideBoard[y, x] == GivenSide){
                                ...
                                if (BootlegLegalMove(UsedIntBoard, UsedSideBoard, x, y, (int) GivenInfo[1], (int) GivenInfo[2]) == true){
